...
<?php
    ...
    if (isset($_POST['Add'])) {
        ...
        $sqlI = "INSERT INTO higher_studies(A_id, Institute_name, course_name) 
                VALUES('$Alumni_id','$Institute_name','$course_name')"; 
                    ...
                    <div class="span9">
                        <div class="content">
                            ...
                            <div class="module-head">
                                <h3 style="text-align: center;">Enter Your Higher Studies Details</h3>
                            </div>
                            <div class="module-body">
                                    ...
                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="form-horizontal row-fluid" >
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="Institute_name" name="Institute_name" class="span8"><br><br>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                name="course_name" class="span8" required><br><br>
                                            </div>
                                        </div>
